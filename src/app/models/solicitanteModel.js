...
class solicitanteModel {
    static validations() {
        return [
            ...
            check('contato_referencia').trim().not().isEmpty().withMessage('O contato de referência precisa ser informado.'),

            check('e_mail').trim().not().isEmpty().withMessage('O e-mail precisa ser informado.').bail()
